...
const App = () => {
    ...
    const getPromptText = () => {
        ...
        if (isEmoji) {
            ...
            const finalActions = activeTheme === 'custom' ? customActions : getThemeField(theme, 'actions');
...
• 所有 ${totalCount} 個格子必須排列整齊，呈現嚴格的均等網格。絕對禁止畫出任何實體的網格線、分隔線、邊框或底框，背景必須是一整片純粹連續的綠色。
...
• 所有 ${totalCount} 個貼圖必須排列整齊，呈現嚴格的均等網格。絕對禁止畫出任何實體的網格線、分隔線、邊框或底框，背景必須是一整片純粹連續的綠色。
